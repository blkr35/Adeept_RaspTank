...
class RobotLight(threading.Thread):
    def __init__(self, *args, **kwargs):
        ...
        self.lightMode = 'none'		#'none' 'police' 'breath' 'k2000'
    ...
    def k2000(self):
        self.lightMode = 'k2000'
        self.resume()


    def k2000Processing(self):
        while self.lightMode == 'k2000':
            for i in range(0,6):
              if i > 0:
                self.setSomeColor(50,0,0,[i-1])
                self.setSomeColor(50,0,0,[6+i-1])
              if i > 1:
                self.setSomeColor(0,0,0,[i-2])
                self.setSomeColor(0,0,0,[6+i-2])
              self.setSomeColor(255,0,0,[i])
              self.setSomeColor(255,0,0,[6+i])
              if i < 5:
                self.setSomeColor(50,0,0,[i+1])
                self.setSomeColor(50,0,0,[6+i+1])
              if i < 1 and i > 4:
    ...
    def lightChange(self):
        ...
        elif self.lightMode == 'k2000':
            self.k2000Processing()
